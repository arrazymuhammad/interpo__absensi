    ...
    <x-component.card>
        ...
        <x-component.form enctype>
            ...
            <div class="row">
                ...
                <div class="col">
                    <x-component.form.input label="Surat Pengantar Lupa Absen" name="pengantar" type="file" />
                    <a href="{{ url('app/lupa-absen/format.doc') }}" class="btn btn-info"><i
                            class="fa fa-download"></i> Download Format</a>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <x-component.form.input label="Bukti" name="bukti" type="file" accept=".pdf" />
                </div>
                <div class="col">
